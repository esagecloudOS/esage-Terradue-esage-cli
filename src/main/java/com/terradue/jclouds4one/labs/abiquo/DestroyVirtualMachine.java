...
@Parameters( commandDescription = "Destroy an existing Virtual Machine." )
public final class DestroyVirtualMachine
	extends BaseTool {    
    ...
    public static void main( String[] args ) {
        ...
        exit( new DestroyVirtualMachine().execute( args ) );
    }
    ...
    public void execute() throws Exception {
    	...
    	logger.info( "Destroying Virtual Machine..." );
